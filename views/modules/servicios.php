        ...
        <div id="dlg" class="easyui-dialog" style="width:400px" data-options="closed:true,modal:true,border:'thin',buttons:'#dlg-buttons'">
            <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
                ...
                <div style="margin-bottom:10px">
                    <input name="cedula" class="easyui-textbox" maxlength="10" required="true" label="Cédula:" style="width:100%">
                </div>
                <div style="margin-bottom:10px">
                    <input name="nombre" class="easyui-textbox" maxlength="20" required="true" label="Nombre:" style="width:100%">
                </div>
                <div style="margin-bottom:10px">
                    <input name="apellido" class="easyui-textbox" maxlength="20" required="true" label="Apellido:" style="width:100%">
                </div>
                <div style="margin-bottom:10px">
                    <input name="telefono" class="easyui-textbox" maxlength="10" required="true" label="Teléfono:" style="width:100%">
                </div>
                <div style="margin-bottom:10px">
                    <input name="direccion" class="easyui-textbox" maxlength="30" required="true" label="Dirección:" style="width:100%">
                </div>
            </form>
        </div>
        ...
        <script type="text/javascript">
            ...
            function editUser() {
                ...
                if (row) {
                    ...
                    $('#fm').form('load', row);
                    url = 'models/editar.php?cedula=' + row.CED_EST;
                    $('#dg').datagrid('reload');
                }
            }
